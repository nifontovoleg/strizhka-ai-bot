...
- Для создания записи вызывай функцию create_booking.
- После успешной записи подтверди детали (услуга, дата, время) и напомни, что придёт SMS-напоминание за день до визита.
