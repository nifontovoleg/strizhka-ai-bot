...
- **Кнопки в интерфейсе**:
  - постоянное нижнее меню (услуги, часы работы, запись, контакты);
...
- Интеграция с Google Календарём вместо/вместе с SQLite.
